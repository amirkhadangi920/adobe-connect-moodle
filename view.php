...
// Get the FolderID
$cond = array('instanceid' => $adobeconnect->id, 'groupid' => $groupid);
$folderid = $DB->get_field('adobeconnect_meeting_groups', 'folderid', $cond);

$meetfldscoid = $folderid ? $folderid : aconnect_get_folder($aconnect, 'meetings');
...
if (
    has_capability('mod/adobeconnect:meetingpresenter', $context) or
