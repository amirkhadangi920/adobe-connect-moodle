...
function adobe_connection_test(
    $host = '',
    $port = 80,
    $username = '',
    $password = '',
    ...
    $aconnectDOM = new connect_class_dom(
        $host,
        $port,
        $username,
        $password,
...
function aconnect_login()
{
    ...
    if (
        isset($CFG->adobeconnect_port) and
    ...
    $aconnect = new connect_class_dom(
        $CFG->adobeconnect_host,
                ...
                for ($x = 0; $x < $innernodelist->length; $x++) {
                    ...
                    if ($innernodelist->item($x)->hasAttributes()) {
                        ...
                        if (!is_null($domnode)) {
                            ...
                            if (!is_null($meetingdetail->getElementsByTagName('date-begin')->item(0))) {
